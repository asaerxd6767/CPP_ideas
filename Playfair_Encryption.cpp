...
//function for the double characters of the text
string double_text(string plain_text){
    string result;
...
int main(){
    ...
    string format_text = double_text(plain_text);
    ...
    matrixdraw(keym);
    cout << "Encrypted: "<< rules(keym, format_text) << endl;
    return 0;
}
